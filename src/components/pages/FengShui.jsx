      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            <h2 className="text-2xl font-semibold mb-4">Book a Consultation or Course</h2>
            <p className="text-gray-700 mb-4">
              Transform your space and life with the power of Feng Shui. Contact us to learn more or schedule a consultation.
            </p>
            <div className="flex gap-4">
              <a
                href="https://wa.me/919886332684?text=Hi,%20I'm%20interested%20in%20Feng%20Shui%20consultation/course"
